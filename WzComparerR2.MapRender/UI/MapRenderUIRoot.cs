...
namespace WzComparerR2.MapRender.UI
{
    class MapRenderUIRoot : UIRoot
    {
        ...
        private void InitializeComponents()
        {
            ...
            ImageManager.Instance.AddImage(nameof(MRes.UI_UIMap_img_MiniMap_BtTown_normal_0));
            ImageManager.Instance.AddImage(nameof(MRes.UI_UIMap_img_MiniMap_BtTown_mouseOver_0));
            ImageManager.Instance.AddImage(nameof(MRes.UI_UIMap_img_MiniMap_BtTown_pressed_0));
            ImageManager.Instance.AddImage(nameof(MRes.UI_UIMap_img_MiniMap_BtTown_disabled_0));
            ImageManager.Instance.AddImage(nameof(MRes.UI_UIMap_img_MiniMap_BtMap_normal_0));
            ImageManager.Instance.AddImage(nameof(MRes.UI_UIMap_img_MiniMap_BtMap_mouseOver_0));
            ImageManager.Instance.AddImage(nameof(MRes.UI_UIMap_img_MiniMap_BtMap_pressed_0));
            ImageManager.Instance.AddImage(nameof(MRes.UI_UIMap_img_MiniMap_BtMap_disabled_0));
            ImageManager.Instance.AddImage(nameof(MRes.UI_UIMap_img_MiniMap_BtNavigation_normal_0));
            ImageManager.Instance.AddImage(nameof(MRes.UI_UIMap_img_MiniMap_BtNavigation_mouseOver_0));
            ImageManager.Instance.AddImage(nameof(MRes.UI_UIMap_img_MiniMap_BtNavigation_pressed_0));
            ImageManager.Instance.AddImage(nameof(MRes.UI_UIMap_img_MiniMap_BtNavigation_disabled_0));
            ImageManager.Instance.AddImage(nameof(MRes.UI_UIMap_img_MiniMap_BtNpc_normal_0));
            ImageManager.Instance.AddImage(nameof(MRes.UI_UIMap_img_MiniMap_BtNpc_mouseOver_0));
            ImageManager.Instance.AddImage(nameof(MRes.UI_UIMap_img_MiniMap_BtNpc_pressed_0));
            ImageManager.Instance.AddImage(nameof(MRes.UI_UIMap_img_MiniMap_BtNpc_disabled_0));
            ImageManager.Instance.AddImage(nameof(MRes.UI_UIMap_img_MiniMap_BtFilter_normal_0));
            ImageManager.Instance.AddImage(nameof(MRes.UI_UIMap_img_MiniMap_BtFilter_mouseOver_0));
            ImageManager.Instance.AddImage(nameof(MRes.UI_UIMap_img_MiniMap_BtFilter_pressed_0));
            ImageManager.Instance.AddImage(nameof(MRes.UI_UIMap_img_MiniMap_BtFilter_disabled_0));
            ImageManager.Instance.AddImage(nameof(MRes.UI_UIMap_img_WorldMap_button_close_normal_0));
            ImageManager.Instance.AddImage(nameof(MRes.UI_UIMap_img_WorldMap_button_close_mouseOver_0));
            ImageManager.Instance.AddImage(nameof(MRes.UI_UIMap_img_WorldMap_button_close_pressed_0));
            ImageManager.Instance.AddImage(nameof(MRes.UI_UIMap_img_WorldMap_button_close_disabled_0));
