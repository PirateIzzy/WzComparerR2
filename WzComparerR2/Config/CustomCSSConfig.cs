...
namespace WzComparerR2.Config
{
    ...
    public class CustomCSSConfig : ConfigSectionBase<CustomCSSConfig>
    {
        ...
        {
            BackgroundColor = Color.FromArgb(Int32.Parse("ffbbbbbb", NumberStyles.HexNumber));
            NormalTextColor = Color.FromArgb(Int32.Parse("ff000000", NumberStyles.HexNumber));
            ChangedBackgroundColor = Color.FromArgb(Int32.Parse("ffcccc00", NumberStyles.HexNumber));
            AddedBackgroundColor = Color.FromArgb(Int32.Parse("ff9ce34e", NumberStyles.HexNumber));
            RemovedBackgroundColor = Color.FromArgb(Int32.Parse("ffff6666", NumberStyles.HexNumber));
