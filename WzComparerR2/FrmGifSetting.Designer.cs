namespace WzComparerR2
{
    partial class FrmGifSetting
    {
        ...
        private void InitializeComponent()
        {
            ...
            superTooltipInfo2.BodyText = "모자이크 방식으로 배경을 설정합니다.";
            ...
            superTooltipInfo3.BodyText = "투명 또는 설정한 색으로 배경을 설정합니다.";
    ...
    ">\r\n &nbsp;%h 출력 이미지 높이(px)<br/>\r\n &nbsp;%t 딜레이(ms)";
            ...
            this.checkBoxX3.Text = "최적화 (8비트 색상 PNG)";
            // 
            // superTabItem2
            // 
