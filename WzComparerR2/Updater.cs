...
namespace WzComparerR2
{
    ...
    {
        private const string checkUpdateURL = "https://api.github.com/repos/PirateIzzy/WzComparerR2/releases/latest";
        ...
        public async Task QueryUpdateAsync(CancellationToken cancellationToken = default)
        {
            ...
            request.Headers.UserAgent.ParseAdd($"WzComparerR2-GMS/1.0");
            ...
            // check version
            this.LatestVersionString = release.TagName;
            this.UpdateAvailable = Int64.Parse(release.TagName) > Int64.Parse(BuildInfo.BuildTime);
