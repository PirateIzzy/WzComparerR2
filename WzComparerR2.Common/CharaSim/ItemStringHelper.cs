    ...
    public static class ItemStringHelper
    {
        ...
        public static string GetGearTypeString(GearType type)
        {
            switch (type)
            {
                ...
                case GearType.dragonWings: return "날개장식";
                case GearType.dragonTail: return "꼬리장식";
                case GearType.glove: return "장갑";
                case GearType.longcoat: return "한벌옷";
                case GearType.machineEngine: return "엔진";
                case GearType.machineArms: return "암";
                case GearType.machineLegs: return "레그";
                case GearType.machineBody: return "프레임";
                case GearType.machineTransistors: return "트랜지스터";
                ...
                case GearType.kodachi2:  return "와키자시";
                ...
                case GearType.boxingCannon: return "무권";
                case GearType.boxingSky: return "권환";
