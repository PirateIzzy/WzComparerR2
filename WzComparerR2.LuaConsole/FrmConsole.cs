...
namespace WzComparerR2.LuaConsole
{
    public partial class FrmConsole : DevComponents.DotNetBar.Office2007Form
    {
        ...
        private void FrmConsole_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            {
                if (DialogResult.Yes != MessageBoxEx.Show(this, "There is a task in progress.\r\nAre you sure you want to quit?", "Notice", MessageBoxButtons.YesNo, MessageBoxIcon.Warning))
                {
                    e.Cancel = true;
                    return;
                }
        ...
        private void menuReset_Click(object sender, EventArgs e)
        {
            ...
            {
                ToastNotification.Show(this, "Previous task in progress.", 1000, eToastPosition.TopCenter);
                return;
            }
            ...
            {
                MessageBoxEx.Show(this, "There is no currently selected script.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
            ...
            this.env.WriteLine("The console has been initialized.");
        }
        ...
        private async void menuRun_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                this.env.WriteLine("Executing: {0}...", selectedEditor.BaseFileName);
        ...
        private void menuStopRun_Click(object sender, EventArgs e)
        {
            ...
            {
                this.cancellationTokenSource.Cancel();
                ToastNotification.Show(this, "Stopping execution...", 1000, eToastPosition.TopCenter);
            }
        }
        ...
        private bool SaveFile(FrmLuaEditor editor, bool saveAs = false)
        {
            ...
            this.env.WriteLine($"====Saved {editor.FileName}====");
            return true;
        }
        ...
        private void FrmLuaEditor_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            {
                switch (MessageBoxEx.Show(this, "Closing the window will cause any unsaved changes to be lost. Do you want to save them? ", "Warning", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Warning))
                {
